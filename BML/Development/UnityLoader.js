...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = 'build1.data';
    var REMOTE_PACKAGE_BASE = 'build1.data';
    ...
    var REMOTE_PACKAGE_NAME = typeof Module['locateFile'] === 'function' ?
      ...
      var REMOTE_PACKAGE_SIZE = 51138308;
      var PACKAGE_UUID = '4ac543c6-3364-4c5e-908a-c2c349d03ead';
...
Module['FS_createPath']('/Managed/mono', '2.0', true, true);
    ...
    DataRequest.prototype = {
      ...
      new DataRequest(0, 48240117, 0, 0).open('GET', '/data.unity3d');
    new DataRequest(48240117, 48240138, 0, 0).open('GET', '/methods_pointedto_by_uievents.xml');
    new DataRequest(48240138, 48240159, 0, 0).open('GET', '/preserved_derived_types.xml');
    new DataRequest(48240159, 49614623, 0, 0).open('GET', '/Il2CppData/Metadata/global-metadata.dat');
    new DataRequest(49614623, 51110683, 0, 0).open('GET', '/Resources/unity_default_resources');
    new DataRequest(51110683, 51138308, 0, 0).open('GET', '/Managed/mono/2.0/machine.config');
    ...
    function processPackageData(arrayBuffer) {
      ...
      DataRequest.prototype.byteArray = byteArray;
          ...
          Module['removeRunDependency']('datafile_build1.data');

    };
    Module['addRunDependency']('datafile_build1.data');
